chrome.runtime.sendMessage({ listenOnRequest: 'https://www.amazon.com/associates/sitestripe/getShortUrl?longUrl=' }, async () => {
  ...
  const affLink = document.querySelector('#amzn-ss-text-shortlink-textarea').textContent
